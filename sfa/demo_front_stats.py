...
"""
SFA3D Front-Only Inference + Jetson Hardware Stats Logging Script
Author: laurent-19
Date: 2025

This script:
- runs SFA3D inference on front BEV maps only
...
if __name__ == '__main__':
    ...
    try:
        ...
        csv_filename = os.path.join(configs.results_dir, f"benchmark_results_front_only_{timestamp}.csv")
        print_true = False
